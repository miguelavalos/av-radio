...
struct AVRadioStationSearchFilters {
    var query: String
    var country: String = ""
...
struct AVRadioStationFallbacks {
    var unnamed: String
    var unknownCountry: String
    var unknownLanguage: String
    var noTags: String

    static let english = AVRadioStationFallbacks(
...
struct AVRadioStationService {
    ...
    private let fallbacks: AVRadioStationFallbacks
    private let invalidResponseMessage: String

    init(
        session: URLSession = .shared,
        fallbacks: AVRadioStationFallbacks = .english,
    ...
    func searchStations(filters: AVRadioStationSearchFilters) async throws -> [Station] {
...
private struct RadioBrowserStationDTO: Decodable {
    ...
    func station(fallbacks: AVRadioStationFallbacks) -> Station? {
