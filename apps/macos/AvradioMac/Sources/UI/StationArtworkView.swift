...
struct StationArtworkView: View {
    ...
    private var backgroundGradient: LinearGradient {
        ...
        case .dark:
            return LinearGradient(
                colors: [AvradioTheme.darkSurface, AvradioTheme.darkSurface.opacity(0.92)],
                startPoint: .topLeading,
                endPoint: .bottomTrailing
            )
        }
    ...
    private var borderColor: Color {
        switch surfaceStyle {
        case .light: return AvradioTheme.borderSubtle
    ...
    private var shadowColor: Color {
        switch surfaceStyle {
        case .light: return AvradioTheme.softShadow.opacity(0.08)
        case .dark: return AvradioTheme.softShadow.opacity(0.18)
        }
    }

    private var fallbackTextColor: Color {
        switch surfaceStyle {
        case .light: return AvradioTheme.textPrimary.opacity(0.92)
        case .dark: return AvradioTheme.textInverse.opacity(0.9)
        }
    }
}
